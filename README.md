...
Этот бот может работать как и от имени пользователя (авторизация от имени приложения ВКонтакте на iPhone), так и от группы. Бот поддержвает работу через User Long Poll API, Callback API.
...
```
#### Связь со мной
Меня можно найти в ВК - https://vk.com/yardanico
